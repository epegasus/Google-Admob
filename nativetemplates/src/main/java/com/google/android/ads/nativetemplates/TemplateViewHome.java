 ...
 */
public class TemplateViewHome extends FrameLayout {
    ...
    public TemplateViewHome(Context context) {
        super(context);
    }

    public TemplateViewHome(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public TemplateViewHome(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView(context, attrs);
    }

    public TemplateViewHome(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
