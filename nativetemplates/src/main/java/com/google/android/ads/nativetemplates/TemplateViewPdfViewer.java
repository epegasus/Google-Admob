 ...
 */
public class TemplateViewPdfViewer extends FrameLayout {
    ...
    public TemplateViewPdfViewer(Context context) {
        super(context);
    }

    public TemplateViewPdfViewer(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public TemplateViewPdfViewer(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView(context, attrs);
    }

    public TemplateViewPdfViewer(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
