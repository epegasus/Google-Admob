 ...
 */
public class TemplateViewExit extends FrameLayout {
    ...
    public TemplateViewExit(Context context) {
        super(context);
    }

    public TemplateViewExit(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public TemplateViewExit(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView(context, attrs);
    }

    public TemplateViewExit(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
